...
// Partial class for the Clinical6 page
public partial class Clinical6 : ContentPage
{
    ...
    // Constructor for Clinical6 page
    public Clinical6(Student selectedStudent)
    {
        InitializeComponent();
